...
if(array_key_exists('pic',$_FILES) && $_FILES['pic']['error'] == 0 ){
	...
	$upload_dir = 'imggallery/images/'.$id_type.'_'.$id.'/';
	...
	if(move_uploaded_file($pic['tmp_name'], $upload_dir.$pic['name']))
	{
		...
		if(file_exists($rfile))
		{
			...
			$ffname=date('Y_m_d_H_m_s').'.jpg';
			$rfile_png=$upload_dir.$ffname;
			
			/*
			$rfile_ffn=$upload_dir.$ffname.'.dat';
