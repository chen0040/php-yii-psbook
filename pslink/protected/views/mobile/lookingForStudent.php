...
<div data-role="page" id="public-students" data-theme="d">
	<div data-role="header" data-theme="a">
		...
		<h1>Students</h1>
		<?php if(!isset($user)): ?>
		<a href="index.php?r=mobile/login&url=lookingForStudent" data-role="button" data-rel="dialog" data-transition="pop">Login</a>
		<?php else: ?>
	...
	<ul data-role="listview" data-theme="d">
		<?php
		$student_group=Student::model()->findAll('looking_for !=""');
		?>
		<?php foreach($student_group as $student): ?>
		<li>
		<a href="index.php?r=mobile/viewStudent&id=<?php echo $student->id; ?>">
