<div class="form">
	...
	<tr>
	<td colspan="2" style="background-color:#333000;color:white;"><b><?php echo Yii::t('translation', 'Province'); ?></b></td>
	</td>
	</tr>
	<tr>
	<td colspan="2">
	...
	<tr>
	<td colspan="2" style="background-color:#333000;color:white;"><b><?php echo Yii::t('translation', 'City'); ?></b></td>
	</tr>
	<tr>
	<td>
	...
	<tr>
	<td colspan="2" style="background-color:#333000;color:white;"><b><?php echo Yii::t('translation', 'School'); ?></b></td>
	</tr>
	<tr>
	<td colspan="2">
        ...
        <?php 
			...
			$cs->registerScript(
				...
				function handleSelectSchoolUpdate(country_val, province_val, city_val, school_val)
				{
					...
					$("#Professor_university").val(new_text);
					$("#university_autocomplete").val(new_text);
