...
if(isset($user) && !$cs->isScriptRegistered('script-'.$data->tag_lcase().'-looking-for'))
{
$cs->registerScript(
'script-'.$data->tag_lcase().'-looking-for',
'
...
');
	...
	<b><?php echo CHtml::encode($data->tag_ucase()); ?>:</b>
	...
	<?php echo CHtml::link(CHtml::encode($data->getSchool()->getInstituteName()), array('educationSchool/view', 'institute_name'=>$data->getSchoolName())); ?>
	<br />


	<b><?php echo Yii::t('translation', $data->getAttributeLabel('research')); ?>:</b>
	<?php echo CHtml::encode($data->research); ?>
	<br />
	
	<b><?php echo Yii::t('translation', $data->getAttributeLabel('email1')); ?>:</b>
	<?php echo CHtml::encode($data->email1); ?>
	<br />
	
	<b><?php echo Yii::t('translation', $data->getAttributeLabel('email2')); ?>:</b>
	...
	{	
		echo CHtml::link('['.Yii::t('translation', 'Resume').']', 
			array('resume2', 'id'=>$data->id), array(
