...
<div style="position: absolute; left: 10px; top: 10px; z-index: 5;border-style:solid;border-width:1px;">
<?php echo $this->renderPartial('../site/_formSearchMap'); ?>
</div>

<div style="position: absolute; left: 720px; top: 10px; width:220px;  z-index: 5;">
<?php echo $this->renderPartial('../site/_formSearchMenubar', array('alink'=>'educationSchool/index')); ?>
</div>

<div style="position: absolute; left: 720px; width: 220px; top: 280px; z-index: 5;">
<?php
echo CHtml::link('&nbsp; Create School &nbsp;<span></span>', array('create'), array(
'style'=>'color:white;',
'class'=>'black',
'id'=>'shiny-blue',
));
