        ...
        <?php 
			...
			$cs->registerScript(
				...
				function handleProvinceUpdate(country_val)
				{
					...
					$.post("index.php?r=student/getProvinces&id='.$model->id.'", 
					{ 
						country:country_val
					},
					function(data) 
				...
				{
					$.post("index.php?r=student/getCities&id='.$model->id.'", 
					{ 
						country:country_val,
				...
				{
					$.post("index.php?r=student/getSchoolsByLocation&id='.$model->id.'", 
					{ 
						country:country_val,
						province:province_val,
						city:city_val
				...
				function handleSelectUpdate(country_val, province_val, city_val, school_val)
				{
					...
					$("#partial_highest_education_school").val(new_text);
