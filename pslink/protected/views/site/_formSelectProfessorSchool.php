<div class="form">
	...
	<table>
	<tr>
	<td colspan="2" style="background-color:#333000;color:white;" class="black"><b><?php echo Yii::t('translation', 'Country'); ?></b></td>
	</tr>
	<tr>
	<td colspan="2">
	<div id="country_fields" style="width:760px;max-width:760px;display:block">
	<?php
	...
	<tr>
	<td colspan="2" style="background-color:#333000;color:white;" class="black"><b><?php echo Yii::t('translation', 'Province'); ?></b></td>
	</td>
	</tr>
	<tr>
	<td colspan="2">
	...
	<tr>
	<td colspan="2" style="background-color:#333000;color:white;" class="black"><b><?php echo Yii::t('translation', 'City'); ?></b></td>
	</tr>
	<tr>
	<td>
	...
	<tr>
	<td colspan="2" style="background-color:#333000;color:white;" class="black"><b><?php echo Yii::t('translation', 'School'); ?></b></td>
	</tr>
	<tr>
	<td colspan="2">
	...
	{
		echo '<a href="#" onclick="handleSelectUpdate(&quot;'.$country.'&quot;, &quot;'.$province.'&quot;, &quot;'.$city.'&quot;, &quot;'.$school.'&quot;); return false;">'.Yii::t('translation', $school).'</a>&nbsp;| ';
	}
	?>
	</div>
	</td>
        ...
        <?php 
			...
			$cs->registerScript(
				...
				function handleProvinceUpdate(country_val)
				{
					...
					$.post("index.php?r=professor/getProvinces&id='.$model->id.'", 
					{ 
						country:country_val
					},
					function(data) 
				...
				{
					$.post("index.php?r=professor/getCities&id='.$model->id.'", 
					{ 
						country:country_val,
				...
				{
					$.post("index.php?r=professor/getSchoolsByLocation&id='.$model->id.'", 
					{ 
						country:country_val,
						province:province_val,
						city:city_val
					...
					function(data) 
					{
						...
						for(var pindex=0; pindex < pcount; ++pindex)
						{
							...
							new_text+=\'<a href="#" onclick="handleSelectUpdate(&quot;\'+country_val+\'&quot;, &quot;\'+province_val+\'&quot;, &quot;\'+city_val+\'&quot;, &quot;\'+data.schools[pindex].name+\'&quot;); return false;">\'+data.schools[pindex].name+\'</a>&nbsp;| \';
						}
				...
				function handleSelectUpdate(country_val, province_val, city_val, school_val)
				{
					var new_text=school_val+", "+city_val+", "+province_val+", "+country_val;
					$("#partial_university").val(new_text);
					$("#select-professor-school-dialog").dialog("close");
				}
				',
