<div class="form">	
	...
	&lt;iframe src="http://www.ps-book.com/psb/index.php?r=professor/linkData&amp;id=<?php echo $model->id; ?>&amp;width=960&amp;height=400" width="960" height="400" frameborder="0" &gt;&lt;/iframe&gt;
	</span>
	</td></tr>
	...
	<tr><td>
	<?php
	echo CHtml::link('Preview Link', array('professor/linkData', 'id'=>$model->id, 'width'=>960, 'height'=>400), array('target'=>'_blank'));
	?>
	</td></tr>
	</table>
