...
$cs->registerScript(
	...
	dropbox.filedrop({
		...
		maxfiles: 5,
    	maxfilesize: 2,
		url: "gallery_upload_video.php?id='.$model->id.'&idtype='.$model->mtype().'",
...
<div id="dropbox">
	<span class="message"><span style="color:white"><?php echo Yii::t('translation', 'Drop your video here to upload'); ?></span></span>
</div>
