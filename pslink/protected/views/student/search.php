...
<table width="100%">
<tr><td>
<div style="font-weight:bold;color:white;" id="titlebar-search" class="black"><?php echo Yii::t('translation', 'Search by Students'); ?></div>
</td></tr>
<tr><td>
...
<?php echo $this->renderPartial('../site/_formSearchMenubar', array('alink'=>'student/search')); ?>
</div>
...
$this->widget('application.extensions.exbreadcrumbs.EXBreadcrumbs', array(
    ...
    'links'=>array(
        ...
        Yii::t('translation', 'Search').' '. Yii::t('translation', 'Student'),
    ),
));
?>
