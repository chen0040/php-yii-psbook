...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<tr>
		<td></td>
		<td>
		<?php echo CHtml::submitButton($model->isNewRecord ? 'Create' : 'Save', array('style'=>'background:transparent url("'.Yii::app()->theme->baseUrl.'/images/blank-blue-button.png") no-repeat center top;width:185px;height:40px;border-style: none;display: block;cursor:pointer;cursor:hand;color:white;')); ?>
		</td>
	</tr>
	</table>
	<br />
