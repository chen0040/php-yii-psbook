...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array(
	...
	'options'=>array(
		...
		'width'=>'auto',
		'height'=>'auto',
		'close' => 'js:function(event, ui) { $("#vplayer").attr("src", "'.Yii::app()->baseUrl.'/jwplayer/jwplayer.php"); }',
	),
));
...
function handleViewVideo(filename, desc)
{
	...
	$("#vplayer").attr("src", "'.Yii::app()->baseUrl.'/jwplayer/jwplayer.php?rp='.urlencode(Yii::app()->getBaseUrl(true)).'&idtype='.$user->mtype().'&id='.$user->id.'&vid="+filename);
	$("#txt_desc").text(desc);
