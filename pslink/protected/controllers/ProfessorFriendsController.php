...
class ProfessorFriendsController extends Controller
{
	/**
	...
	{
		$model=new ProfessorFriends;
		$model->professor_id=$this->_professor->id;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['ProfessorFriends']))
		{
			$model->attributes=$_POST['ProfessorFriends'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('ProfessorFriends');
	...
	{
		$model=new ProfessorFriends('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ProfessorFriends']))
			$model->attributes=$_GET['ProfessorFriends'];
	...
	{
		$model=ProfessorFriends::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='professor-friends-form')
		{
