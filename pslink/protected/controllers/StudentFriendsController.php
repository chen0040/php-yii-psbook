...
class StudentFriendsController extends Controller
{
	...
	{
		$model=new StudentFriends;
		$model->student_id=$this->_student->id;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['StudentFriends']))
		{
			$model->attributes=$_POST['StudentFriends'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('StudentFriends');
	...
	{
		$model=new StudentFriends('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['StudentFriends']))
			$model->attributes=$_GET['StudentFriends'];
	...
	{
		$model=StudentFriends::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='student-friends-form')
		{
